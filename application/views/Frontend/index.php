						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="<?php echo base_url().'index.php/Frontend/produk_kategori/'.$kategori->id_kategori.'' ?>"><?php echo $kategori->nm_kategori ?></a></h4>
								</div>
							</div>
							<?php } ?>
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $produk->harga ?></h2>
												<p><?php echo $produk->nm_produk ?></p>
												<a href="<?php echo base_url().'index.php/Frontend/register/'.$produk->id_produk.'' ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
							</div>
