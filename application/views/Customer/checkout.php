	<section id="cart_items">
		<div class="container">
			...
			<form method="POST" action="<?php echo base_url().'index.php/Customer/bayar_input_aksi'?>">
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<input type="hidden" name="no_referensi" value="<?php echo $checkout->no_referensi ?>">
					...
					<tr>
						<td class="cart_description" colspan="3" rowspan="3" align="center">
							<h4>Pembayaran Melalui Rekening BRI : <br>An. E-Farming : <?php echo $this->session->userdata('ses_name')?><br>123-456-788-28-5 </h4>
						</td>
						...
						<td class="cart_total">
							...
							<input type="hidden" name="status_checkout" value="Sudah Dibayar">
						</td>
					</tr>
					<tr>
						<td class="cart_description" align="left">
				...
				<button type="submit" class="btn btn-fefault cart"><i class="fa fa-shopping-cart"></i>bayar</button>
			</form>
